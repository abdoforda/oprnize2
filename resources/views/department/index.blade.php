                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6">
                        <div class="float-end d-none d-sm-block">
                            ...
                            data-bs-target=".bs-example-modal-lg" class="btn btn-success">{{__('Add a new Department')}}</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title">{{ __('Departments') }}</h4>
                                <p class="card-title-desc">
                                    {{__('You can add and edit Departments from this page')}}
                                </p>
...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title mt-0" id="myLargeModalLabel">{{__('Add a new Department')}}</h5>
        ...
        <div class="modal-body">
            ...
            <form action="/department" class="ajax_nationality" method="post">
                @csrf
                <div class="row mb-3">
                    <label for="example-text-input" class="col-sm-2 col-form-label">{{__('Department Name (AR)')}}</label>
                    <div class="col-sm-10">
