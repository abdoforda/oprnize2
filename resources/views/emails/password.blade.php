...
<div style="line-height:10px"><img alt="Image" src="https://demo.oprnize.com/new/Logo.png" style="display: block; height: auto; border: 0; width: 195px; max-width: 100%;" title="Image" width="195"/></div>
</td>
</tr>
</table>
</td>
...
<tr>
<td style="padding-right:0px;padding-bottom:25px;padding-left:0px;padding-top:25px;">
<div></div>
</td>
</tr>
</table>
...
<div align="center" style="line-height:10px"><img alt="Image" src="https://demo.oprnize.com/new/illo_welcome_1.png" style="display: block; height: auto; border: 0; width: 540px; max-width: 100%;" title="Image" width="540"/></div>
</td>
</tr>
</table>
...
<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 51px;"><span style="font-size:34px;"><strong><span style="font-size:34px;">


    <a href="{{ $email['domain'].".".request()->getHost() }}">
        <span style="color:#2190e3;font-size:34px;">{{ $email['domain'].".".request()->getHost() }}</span>
    </a>
...
<tr>Email: {{ $email['email'] }}</tr>
<tr>password: {{ $email['pass'] }}</tr>
</table>
...
<tr>
<td style="padding:0 15px 0 0px;"><a href="https://www.facebook.com/" target="_blank"><img alt="Facebook" height="32" src="https://demo.oprnize.com/new/facebook2x.png" style="display: block; height: auto; border: 0;" title="Facebook" width="32"/></a></td>
<td style="padding:0 15px 0 0px;"><a href="https://twitter.com/" target="_blank"><img alt="Twitter" height="32" src="https://demo.oprnize.com/new/twitter2x.png" style="display: block; height: auto; border: 0;" title="Twitter" width="32"/></a></td>
<td style="padding:0 15px 0 0px;"><a href="https://instagram.com/" target="_blank"><img alt="Instagram" height="32" src="https://demo.oprnize.com/new/instagram2x.png" style="display: block; height: auto; border: 0;" title="Instagram" width="32"/></a></td>
<td style="padding:0 15px 0 0px;"><a href="https://www.pinterest.com/" target="_blank"><img alt="Pinterest" height="32" src="https://demo.oprnize.com/new/pinterest2x.png" style="display: block; height: auto; border: 0;" title="Pinterest" width="32"/></a></td>
</tr>
</table>
</td>
</tr>
...
<p style="margin: 0; font-size: 14px; text-align: center;">NetShop - Lorem ipsum dolor sit amet hasellus sagittis aliquam luctus. </p>
