                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6">
                        <div class="float-end d-none d-sm-block">
                            ...
                            data-bs-target=".bs-example-modal-lg" class="btn btn-success">{{__('Add a new')}} {{__('Jobs')}}</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title">{{ __('Jobs') }}</h4>
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                    ...
                                    <tbody class="append2">
                                        ...
                                        <tr id="updater{{$index}}">
                                            ...
                                            <td >
                                                <a class="inline-department" href="#" data-type="select" data-pk="{{ $nationality->id }}" data-value="{{ $nationality->section->id }}" data-url="/update_section" >{{ $nationality->section->name }}</a>
                                                </td>
                                            <td>
                                                ...
                                                <button onclick="delete_tr(this,'jobs','updater{{$index}}')" data-id="{{ $nationality->id }}" type="button" class="btn btn-danger btn-sm waves-effect waves-light"><i class="fas fa-trash"></i> {{__('Delete')}}</button>
                                            </td>
                                        </tr>
                                        @endforeach
...
function update_nationality(thiss,id){
    ...
    $(".ajax_nationality2").attr('action','/job/'+thiss.data('id'));
                ...
                complete: function(data){
                    ...
                    if(data.status == 422){
                        ...
                        $(".append2").prepend(`<tr id="asdww${data.responseJSON.id}">
                                            ...
                                            <td>${data.responseJSON.section.name_en} - ${data.responseJSON.section.name_ar}</td>
                                            <td>
...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title mt-0" id="myLargeModalLabel">{{__('Add a new')}} {{__('Job')}}</h5>
        ...
        <div class="modal-body">
            ...
            <form action="/job" class="ajax_nationality" method="post">
                @csrf

                <div class="row mb-3">
                    <label for="example-text-input" class="col-sm-2 col-form-label">{{__('Section')}}</label>
                    <div class="col-sm-10">
